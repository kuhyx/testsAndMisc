...
run_dbus_throttle_case() {
	...
	# The `bash -c` body below is a script for a CHILD shell - $1,
	# $TEST_CHECK_INTERVAL, $COUNTER_FILE and ${mock_ts[...]} must reach it
	# UNEXPANDED and be evaluated there. Single quotes are load-bearing.
