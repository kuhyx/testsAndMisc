...
# --- qalc (richer engine) for "="-prefixed lines ------------------------------
# Sourced after _CALC_QALC_BIN and _CALC_TIMEOUT_BIN above, which it reads.
# ${0:A:h} follows the oh-my-zsh symlink back to the real directory in the repo,
# the same idiom used for _CALC_EVAL_PY above.
source ${0:A:h}/calc-live-qalc.zsh
