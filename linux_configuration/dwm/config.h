...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_m,          spawn,          SHCMD("$HOME/src/testsAndMisc/linux_configuration/utils/volume_control.sh micmute") },

	/* media keys — routed through volume_control.sh, same as the (now-fixed) i3 config */
	{ 0, XF86XK_AudioRaiseVolume,                  spawn,          SHCMD("$HOME/src/testsAndMisc/linux_configuration/utils/volume_control.sh up") },
	{ 0, XF86XK_AudioLowerVolume,                  spawn,          SHCMD("$HOME/src/testsAndMisc/linux_configuration/utils/volume_control.sh down") },
	{ 0, XF86XK_AudioMute,                         spawn,          SHCMD("$HOME/src/testsAndMisc/linux_configuration/utils/volume_control.sh mute") },
	{ 0, XF86XK_AudioMicMute,                      spawn,          SHCMD("$HOME/src/testsAndMisc/linux_configuration/utils/volume_control.sh micmute") },
