...
export type UnitKind = 'rusher' | 'stalker' | 'tank' | 'bomber'
export type BossKind = 'colossus' | 'hivemind'
...
export const UNIT_ORDER: readonly [UnitKind, ...UnitKind[]] = ['rusher', 'stalker', 'tank', 'bomber']
export const BOSS_ORDER: readonly [BossKind, ...BossKind[]] = ['colossus', 'hivemind']
export const BOSS_UNLOCK_AT: Record<BossKind, number> = { colossus: 60, hivemind: 120 }
export const BOSS_COOLDOWN: Record<BossKind, number> = { colossus: 25, hivemind: 30 }
