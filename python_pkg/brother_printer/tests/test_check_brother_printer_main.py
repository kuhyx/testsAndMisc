"""Tests for brother_printer.check_brother_printer - the CLI entry point.

Split from test_check_brother_printer.py under the 250-line cap. These cover
argument handling, mode selection and the consumable reset flags.
"""
