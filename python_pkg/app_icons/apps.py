...
all that is needed for it to get an on-style icon. The accent is deliberately
taken from each app's own theme seed so the launcher icon matches the app's
first screen.
"""
...
class AppIcon:
    ...
    accent (str): Hex accent colour, matching the app's theme seed.
